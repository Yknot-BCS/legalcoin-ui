...
<template lang="pug">
transition(v-if='viewCard', appear, enter-to-class='animated flipInY' :duration='1000')
  q-card
    //- Desktop
    q-card-section.bg-white(style='z-index: 2, height: 3rem')(v-if='$q.screen.gt.sm')
...
transition(v-if='viewInfo', appear, enter-to-class='animated flipInY', leave-to-class='animated flipOutY')
  q-card
    //- Desktop
